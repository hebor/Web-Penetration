...
1. 安装
   ...
   https://github.com/hunhepan/desktop/releases/tag/v1.1.1，从github下载压缩包到本地解压运行即可

2. 更新规则

   Windows客户端无需配置规则即可直接使用，MAC端需要先配置规则后使用，但Windows客户端也可以对规则进行更新，通过Git的方式导入规则可以直接使用另外一个github仓库：https://github.com/hunhepan/hunhepan-rule-template

   ![混合盘-1](../image/Part_2/混合盘-1.png)

3. 使用

   ![混合盘-2](../image/Part_2/混合盘-2.png)
