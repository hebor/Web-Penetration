...
当前在Github上搜索没有获取到有效信息时是很正常的，搜索姿势不对或者目标确实没有上传敏感信息到Github上，秉承一切皆有可能的理念，万一目标系统以后将自己的敏感代码上传到Github上了，通过信息泄露监控工具即可尽快收到相关信息，再进行信息收集
...
2. 1
   ...
   首次使用浏览器访问`http://127.0.0.1:8001`即可看到页面。
